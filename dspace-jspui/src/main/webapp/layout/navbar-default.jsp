...
%>
       ...
       <div class="navbar-header">
         ...
         <a class="navbar-brand" href="<%= request.getContextPath() %>/"><img height="53" src="<%= request.getContextPath() %>/image/dissco-logo-web-white.svg" alt="DiSSCo logo" /></a>
       </div>
 ...
 %>
	...
	<form method="get" action="<%= request.getContextPath() %>/simple-search" class="navbar-form navbar-right">
	    <div class="form-group">
          <input type="text" class="form-control" placeholder="Search DiSSCo" name="query" id="tequery" size="25"/>
        </div>
